...
public class MITrades {
    ...
    public static void init(){
        ...
        VillagerTrades.TRADES.put(MIProfession.MARINE_BIOLOGIST,toIntMap(ImmutableMap.of(
        ...
        VillagerTrades.TRADES.put(MIProfession.MYCOLOGIST,toIntMap(ImmutableMap.of(
    ...
    //<editor-fold desc="Profession Name">
    // </editor-fold>
}
